...
use dcode_chatgpt::connectors::AppInfo;
...
pub(crate) enum AppEvent {
    ...
    DcodeOp(dcode_protocol::protocol::Op),
    ...
    /// Persist the selected provider to config and request an app restart.
