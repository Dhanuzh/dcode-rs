...
use dcode_api::common::OpenAiVerbosity;
use dcode_api::common::TextControls;
...
fn serializes_text_schema_with_strict_format() {
    ...
    assert_eq!(
        format.get("name"),
        Some(&serde_json::Value::String("dcode_output_schema".into()))
    );
    assert_eq!(
        format.get("type"),
...
fn tool_search_output_namespace_serializes_with_deferred_child_tools() {
    let namespace = tools::ToolSearchOutputTool::Namespace(tools::ResponsesApiNamespace {
        name: "mcp__dcode_apps__calendar".to_string(),
    ...
    assert_eq!(
        ...
        serde_json::json!({
            "type": "namespace",
            "name": "mcp__dcode_apps__calendar",
