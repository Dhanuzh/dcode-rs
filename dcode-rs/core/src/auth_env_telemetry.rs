use dcode_otel::AuthEnvTelemetryMetadata;

use crate::auth::DCODE_API_KEY_ENV_VAR;
...
pub(crate) struct AuthEnvTelemetry {
    ...
    pub(crate) dcode_api_key_env_present: bool,
    pub(crate) dcode_api_key_env_enabled: bool,
...
impl AuthEnvTelemetry {
    pub(crate) fn to_otel_metadata(&self) -> AuthEnvTelemetryMetadata {
        AuthEnvTelemetryMetadata {
            ...
            dcode_api_key_env_present: self.dcode_api_key_env_present,
            dcode_api_key_env_enabled: self.dcode_api_key_env_enabled,
...
pub(crate) fn collect_auth_env_telemetry(
    ...
    dcode_api_key_env_enabled: bool,
) -> AuthEnvTelemetry {
    AuthEnvTelemetry {
        openai_api_key_env_present: env_var_present(OPENAI_API_KEY_ENV_VAR),
        dcode_api_key_env_present: env_var_present(DCODE_API_KEY_ENV_VAR),
        dcode_api_key_env_enabled,
